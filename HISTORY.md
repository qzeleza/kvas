...
- Перед добавлением домена в список (add и import) теперь происходит проверка доступности интернета и VPN соеднения.
- Исправлена ошибка при выполнении команд hosts add и hosts edit [issue [#125](https://github.com/qzeleza/kvas/issues/125)]
- Исправлена ошибка приводившая к появлению записей типа "jq: error: description/0 is not defined...", в лог файле [issue [#132](https://github.com/qzeleza/kvas/issues/132)]
- Обновлены файл справки и Wiki проекта (по правкам выше)
- Обновлена и улушена процедура получения IP для доменных имен.
- Обновлен файл запуска /opt/etc/init.d/S99adguardhome, теперь можно обновлять ADGH прямо из web-интерфейса самой программы.
