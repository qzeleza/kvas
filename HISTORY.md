...
- Добавлена возможность тестировать любой введенный домен при исполнении команды 'kvas dns test domain.com'. По умолчанию, текстируется домен facebook.com. 
- Дополнены файлы справки и документация по проекту. 
- Добавлен ключ '-h' для вызова справки.
