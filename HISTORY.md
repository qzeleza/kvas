...
- Благодаря [@PsychodelEKS](https://t.me/PsychodelEKS), появилась возможность отключить использование DNS провайдера в автоматическом режиме и установке пакета (пока в стадии тестирования).
