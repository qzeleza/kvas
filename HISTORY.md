...
- Добавлена новая команда reset|init которая пересосздает все правила в случае сбоя или проблем с разблокировкой.
- Введно новое правило при добавлении домена без звездочки - проверка на доступность домена осуществляться будет, а при синтаксисе добавляемого домена *domain.dom, проверка на доступность осуществляться не будет.
