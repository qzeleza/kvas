...
## Список изменений 
- Крайняя версия Кваса  [1.0 beta 19](https://github.com/qzeleza/kvas/blob/main/ipk/)
...
# Использование AdGuard Home совместно с пакетом Квас

```
Данная команда должна исполнятся уже после установки  AdGuard Home и его первичной настройки, 
при этом сам AdGuard Home должен быть установлен исключительно на роутер на котором установлен сам пакет Квас.
Удаленная установка AdGuard Home на другое устройство и совместное использование его с пакетом Квас - НЕВОЗМОЖНО!
```

## Последовательность шагов:
1. Устанавливаем и запускаем AdGuard Home: 
   - Устанавливаем: `opkg install adguardhome-go`
   - Запускаем настройку командой `AdGuardHome` и следуем инструкциям на экране.
...
4. Включаем AdGuard Home в пакете Квас командой `kvas adguard on`
